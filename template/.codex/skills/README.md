...
Reusable skills in this folder are copied from the repository root `skills/` directory so a bootstrapped project is self-contained.

If you update the reusable skills in this repository, sync them back into this folder with:
